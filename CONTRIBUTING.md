...
Welcome to `cytodatagen` contributor's guide.
...
If you experience bugs or general issues with `cytodatagen`, please have a look
...
You can help improve `cytodatagen` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cytodatagen` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cytodatagen`'s files. While this mechanism can
...
```
conda create -n cytodatagen python=3 six virtualenv pytest pytest-cov
conda activate cytodatagen
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cytodatagen.git
   cd cytodatagen
   ```
...
5. Install [pre-commit]:
   ...
   `cytodatagen` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cytodatagen
[issue tracker]: https://github.com/<USERNAME>/cytodatagen/issues
